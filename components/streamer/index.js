...
export default function StreamerCard({ streamer }) {
  ...
  const isFavorite = settings.favorites?.includes(streamer.name?.toLowerCase());
  ...
  return (
    <div
      ...
      className="relative flex-auto w-1/4 flex items-center h-auto p-3 border border-black/10 dark:border-white/10 rounded-[30px] bg-white/50 dark:bg-black/20 backdrop-blur-sm transition-all duration-300 overflow-hidden"
    >
